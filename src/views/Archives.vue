            ...
            <div class="right">
                <el-card shadow="hover" class="evaluate-list">
                    ...
                    <ul>
                        <li v-for="i in evaluateList">
                            <el-button type="text" icon="el-icon-edit" @click="eva(i.id)">{{year}}第{{i.weekly}}周评价
                            </el-button>
                        </li>
                    </ul>
                </el-card>
                <el-card shadow="hover" class="rank-list">
                    <header slot="header">
                        ...
                        <span :class="{notActive:classRankShow}" @click="classRankShow=!classRankShow">年级排名</span>
                    </header>
        ...
        <el-dialog :visible.sync="dialogVisible">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
                ...
                <el-form-item label="获奖时间">
                    <el-date-picker v-model="ruleForm.archive_date" type="date" placeholder="选择日期"
                ...
                <el-form-item label="附件">
                    <el-upload :action="$proxy+'/upload/uploadFile'" :on-remove="handleRemove"
                               :on-success="handleSuccess" :file-list="ruleForm.imglist">
...
<script>
    export default {
        ...
        methods: {
            ...
            //获取学校维度列表
            getSchoolList() {
                this.$ajax.post('/api/archives/getSchoolDimensionalityList', {isAddStudent: 0})
                    .then(res => {
